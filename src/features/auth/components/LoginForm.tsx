...
export default function LoginForm() {
  ...
  return (
    <div className="w-full max-w-md bg-sats-black-950/80 border border-sats-black-800 rounded-3xl p-8 shadow-[0_0_50px_rgba(249,115,22,0.1)] relative font-sans backdrop-blur-xl mx-auto mt-10">
        ...
        <div className="flex justify-center items-center mb-6 mt-2">
          <div className="flex items-center space-x-2">
            <div className="w-12 h-12 bg-black rounded-xl border border-sats-orange-500/30 flex items-center justify-center relative shadow-[0_0_15px_rgba(249,115,22,0.2)]">
              <Image width={120} height={120} className='rounded-2xl object-cover' alt='logo' src='/icon.png' />
            </div>
      ...
      {/* 🚨 Error Message Display: Safeguard against non-string rendering */}
      {error && (
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div>
          <div className="flex justify-between items-center mb-1.5">
            ...
            <Link href="/forgotpassword" className="text-xs font-medium text-sats-orange-500 hover:text-sats-orange-400 transition-colors">
              Forgot password?
            </Link>
          </div>
          <div className="relative group">
