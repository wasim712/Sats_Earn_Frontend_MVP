      ...
      <div className="mx-auto max-w-4xl space-y-8">
        ...
        <section className="grid gap-5 md:grid-cols-2">
          <div className="rounded-3xl border border-[#1a1a1a] bg-[#080808] p-6">
            ...
            <p className="mt-4 text-sm font-bold text-sats-orange-400">Email: support@satsearn.app</p>
          </div>
          ...
          <div className="rounded-3xl border border-[#1a1a1a] bg-[#080808] p-6">
            ...
            <p className="mt-4 text-sm font-bold text-sats-orange-400">Email: wasim@satsearn.app</p>
          </div>
        </section>
      </div>
    </main>
