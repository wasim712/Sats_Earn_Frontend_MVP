...
{/* ─── PLATFORM HEALTH ─── */}
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <a href="https://discord.gg/VX4cB2xTnZ" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 bg-[#050505] border border-[#1a1a1a] rounded-2xl p-5 hover:border-sats-orange-500/30 transition-all group">
              <div className="w-11 h-11 rounded-xl bg-sats-orange-500/10 border border-sats-orange-500/20 flex items-center justify-center shrink-0 text-sats-orange-500">
        ...
        <div id="connect" className="text-center pt-8 border-t border-[#1a1a1a] scroll-mt-24">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <a href="https://discord.gg/VX4cB2xTnZ" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-2.5 bg-[#050505] border border-[#1a1a1a] rounded-[14px] px-4 py-6 hover:border-sats-orange-500/30 hover:-translate-y-[3px] hover:bg-[#0a0a0a] transition-all group">
