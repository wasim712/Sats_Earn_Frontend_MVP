    ...
    <header className="text-center pt-20  px-4">
      ...
      <FadeUp delay={0.2}>
        <h1 className="font-black text-4xl sm:text-5xl md:text-7xl leading-[1.05] tracking-tight mb-5 text-white max-w-4xl mx-auto">
          Withdraw Real <span className="bg-linear-to-r from-sats-orange-400 via-sats-orange-500 to-sats-orange-600 bg-clip-text text-transparent relative">Bitcoin Sats</span>
        </h1>
      </FadeUp>
      <FadeUp delay={0.3}>
