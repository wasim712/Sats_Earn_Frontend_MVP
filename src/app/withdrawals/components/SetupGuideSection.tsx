...
export function SetupGuideSection() {
  ...
  return (
    <section className="py-12 relative px-4 max-w-5xl mx-auto">
      <FadeUp delay={0.1}>
      ...
      <FadeUp delay={0.5}>
        <p className="text-[12px] sm:text-xs text-gray-400 italic text-center max-w-3xl mx-auto leading-relaxed">
