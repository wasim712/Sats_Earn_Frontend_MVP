...
import { 
  ...
  MonitorCog, Bell, Bug,
  ShieldAlert, BookOpen, CircleHelp, Sparkles, Crown
} from 'lucide-react';
...
export const AdminSidebar = ({ isOpen, isCollapsed, onClose, onToggleCollapse, onLogout }: AdminSidebarProps) => {
  ...
  const navLinks = [
    ...
    { name: 'Premium Requests', href: '/admin/premium-requests', icon: Crown },
    ...
    { type: 'divider', name: 'Standalone' },
    { name: 'All Standalone Tasks', href: '/admin/tasks', icon: CheckSquare },
    { name: 'Create Standalone Task', href: '/admin/addtask', icon: CopyPlus },
