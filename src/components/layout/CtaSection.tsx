          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
            ...
            <Link href="/brands" className="w-full sm:w-auto">
              <Button
                variant="secondary"
                size="lg"
                className="w-full gap-2 bg-sats-black-900 border-sats-black-700 hover:border-sats-orange-500/50 hover:text-sats-orange-500 group/btn transition-colors"
              >
                <Megaphone className="w-5 h-5 text-gray-400 group-hover/btn:text-sats-orange-500 transition-colors" />
                Advertise With Us
                <ArrowRight className="w-5 h-5 text-gray-500 group-hover/btn:text-sats-orange-500 group-hover/btn:translate-x-1 transition-all" />
              </Button>
            </Link>
          </div>
