...
// --- DATA CONFIGURATION ---
// I left all the hrefs as '#' so you can easily plug in your links later!
const FOOTER_LINKS = {
  Earn: [
...
// Custom high-resolution SVGs for authentic brand icons (since Lucide doesn't have them)
const SOCIAL_LINKS = [
  {
    name: 'X (Twitter)',
    ...
    icon: (
      <svg
        viewBox="0 0 24 24"
        className="w-5 h-5 fill-gray-400 transition-all duration-300 
        hover:fill-white hover:scale-110 hover:drop-shadow-[0_0_8px_white]"
        aria-hidden="true"
      >
...

  {
    ...
    icon: (
      <svg
        viewBox="0 0 24 24"
        className="w-5 h-5 fill-gray-400 transition-all duration-300 
        hover:fill-blue-500 hover:scale-110 hover:drop-shadow-[0_0_10px_#3b82f6]"
        aria-hidden="true"
      >
...

  {
    ...
    icon: (
      <svg
        viewBox="0 0 24 24"
        className="w-5 h-5 fill-gray-400 transition-all duration-300 
        hover:fill-red-500 hover:scale-110 hover:drop-shadow-[0_0_10px_#ef4444]"
        aria-hidden="true"
      >
...

  {
    ...
    icon: (
      <div className="group">
        <svg
          viewBox="0 0 24 24"
          className="w-5 h-5 fill-gray-400 transition-all duration-500 
          group-hover:fill-[#E1306C] 
          group-hover:scale-110 
          group-hover:drop-shadow-[0_0_12px_#E1306C]"
          aria-hidden="true"
        >
          <path
            fillRule="evenodd"
...
export const Footer = () => {
  ...
  return (
    // Pure black background to anchor the bottom of the site
    <footer className="relative bg-sats-black-950 border-t border-sats-black-800 pt-20 pb-10 overflow-hidden z-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8 mb-20">
          ...
          {/* Column 1: Brand Info (Takes up 2 columns on desktop for visual balance) */}
        ...
        <div className="pt-8 border-t border-sats-black-800 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          {/* Right: Social Icons (Empty text constraint met) */}
