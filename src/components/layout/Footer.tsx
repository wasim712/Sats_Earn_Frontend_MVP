        ...
        <div className="pt-8 border-t border-sats-black-800 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className=" flex flex-col">
              <p className="text-gray-400 font-medium leading-relaxed text-base sm:text-base lg:hidden">
                Made with <span className="heart-beat inline-block align-[-2px] mx-1"><svg viewBox="0 0 24 24" width="15" height="15" fill="#f7931a" xmlns="http://www.w3.org/2000/svg"><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/></svg></span> for the <span className="text-sats-orange-500">Bitcoin</span> community
              </p>
              
              <p className="text-white text-base font-bold text-center md:text-left">
                  © {currentYear} SatsEarn. All rights reserved.
              </p>
            </div>
            <p className="text-white font-bold leading-relaxed text-base hidden lg:block">
                Made with <span className="heart-beat inline-block align-[-2px] mx-1"><svg viewBox="0 0 24 24" width="15" height="15" fill="#f7931a" xmlns="http://www.w3.org/2000/svg"><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/></svg></span> for the <span className="text-sats-orange-500">Bitcoin</span> community
              </p>
