...
function normalizeNotificationsResponse(data: unknown): NotificationItem[] {
  ...
  if (data && typeof data === "object") {
    ...
    if (payload.data && typeof payload.data === "object") {
      ...
      if (isNotificationArray(nested.notifications))
        return nested.notifications;
...
export const UserSidebar = ({
  ...
  const navLinks = [
    ...
    },
    {
      key: "bugBounty",
      name: "Bug Bounty",
      href: "/user/bug-bounty",
      icon: Bug,
    },
    { key: "quiz", name: "Daily Quiz", href: "/user/quiz", icon: Lightbulb },
    {
      key: "referrals",
      name: "Referrals",
      href: "/user/referrals",
    ...
    { key: "rewards", name: "Rewards", href: "/user/rewards", icon: Medal },
    {
      key: "leaderboard",
      name: "Leaderboard",
    ...
    { key: "wallet", name: "Withdraw", href: "/user/wallet", icon: Wallet },
    {
      key: "settings",
      name: "Settings",
      href: "/user/settings",
  ...
  return (
    <>
      ...
      >
        <div
          className={`flex h-24 items-center bg-sats-black-950 transition-all duration-300 ${isCollapsed ? "justify-center px-0" : "justify-between px-6"}`}
        >
            ...
            return (
              ...
              >
                <div className="relative flex items-center gap-4">
                  <Icon
                    className={`h-5 w-5 min-w-[20px] transition-colors duration-300 ${isActive ? "text-sats-orange-500" : "text-gray-400 group-hover:text-gray-300"}`}
                  />
                  {!isCollapsed && (
