    ...
    >
      ...
      <div style={{ background: C.surf2, border: `1px solid ${C.line2}`, borderRadius: 14, padding: 22 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14, marginTop: 16, flexWrap: "wrap" }}>
          <button onClick={submit} disabled={!valid} style={{ ...primaryBtn, opacity: valid ? 1 : 0.5, cursor: valid ? "pointer" : "not-allowed" }}>Submit application</button>
          {sent && <span style={{ color: C.grn, fontSize: 13, fontWeight: 600 }}>✓ Opening your email to send — we'll review and get back to you.</span>}
